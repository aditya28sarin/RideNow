...
// Driver Photo Controller
@Named("driverPhotoController")
@SessionScoped
public class DriverPhotoController implements Serializable {
    ...
    public String capturedPhoto() {
        return Constants.PHOTOS_URI_DRIVER + filename;
    }

    //   Handle Driver Photo Capture
    public void onCapture(CaptureEvent captureEvent) {


        Map<String, Object> sessionMap = FacesContext.getCurrentInstance().getExternalContext().getSessionMap();
        Driver signedInUser = (Driver) sessionMap.get("driver");


        filename = signedInUser.getId() + "_tempFile";

        String absolutePathOfFilename = Constants.PHOTOS_ABSOLUTE_PATH_DRIVER + filename;
        ...
        DriverPhoto newPhoto = new DriverPhoto("png", signedInUser);

        driverPhotoFacade.create(newPhoto);


        DriverPhoto photo = driverPhotoFacade.findPhotosByDriverPrimaryKey(signedInUser.getId()).get(0);
    ...
    public void storePhotoFile(UploadedFile file) {
        ...
        try {
            ...
            DriverPhoto newPhoto = new DriverPhoto(fileExtension, signedInUser);
    ...
    private File inputStreamToFile(InputStream inputStream, String targetFilename) throws IOException {
        ...
        try {
            ...
            targetFile = new File(Constants.PHOTOS_ABSOLUTE_PATH_DRIVER, targetFilename);
    ...
    private void saveThumbnail(File inputFile, DriverPhoto inputPhoto) {
        ...
        try {
            ...
            File thumbnailPhotoFile = new File(Constants.PHOTOS_ABSOLUTE_PATH_DRIVER, inputPhoto.getThumbnailFileName());
    ...
    //   Delete Driver Photo and Thumbnail
    public void deletePhoto() {
        ...
        if (!photoList.isEmpty()) {
            ...
            DriverPhoto photo = photoList.get(0);
            ...
            try {
                ...
                driverPhotoFacade.remove(photo);
